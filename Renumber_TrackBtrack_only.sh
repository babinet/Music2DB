...
echo "${WHITE}---> JE SUIS                    : ${green}Renumber_TrackBtrack_only.sh"
...
ffmpeg -i "$thefilelist" -c copy -metadata track="$newtracknumber" ../_Processed/"$ParentDir2Album"/"$newtracknumber"_"$FileOutNoExt"."$extension"
