...
ffmpeg -i "$thefilelist" -c copy -metadata track="$newtracknumber" -metadata title="$newtracname" ../_Processed/"$ParentDir2Album"/"$newtracknumber"_"$FileOutNoExt"."$extension"
